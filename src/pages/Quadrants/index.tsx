...
import { homeConfig, quadrantsConfig } from '@/constants/config';
    ...
    return <div className=" bg-[#f2f5fe] w-full h-full flex">
        ...
        <div className=" flex justify-between h-full p-[20px] flex-1">
            <div className={`${styles.container} grid grid-cols-1  gap-4 w-[40%]`}>
                <div className={`${styles.item} bg-white group p-[10px]  border-[1px] aspect-w-1 aspect-h-1 hover:border-red-300 hover:bg-[rgba(255,255,255,.5)]`}>
                ...
                <div className={`${styles.item} bg-white group p-[10px] border-[1px] aspect-w-1 aspect-h-1 hover:border-yellow-300 hover:bg-[rgba(255,255,255,.5)]`}>
                ...
                <div className={`${styles.item} bg-white group p-[10px] aspect-w-1 border-[1px] aspect-h-1 hover:border-blue-300 hover:bg-[rgba(255,255,255,.5)]`}>
                ...
                <div className={`${styles.item} p-[10px] bg-white group aspect-w-1 border-[1px] aspect-h-1 hover:border-green-300 hover:bg-[rgba(255,255,255,.5)]`}>
